...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setStyleSheet("background-color: rgb(157, 233, 255);")
        ...
        self.lineEdit_2.setStyleSheet("border-radius:6;\n"
...
"border: 1px solid  black;")
        ...
        self.pushButton.setStyleSheet("border-radius:16;\n"
"background-color: rgb(255, 255, 255);\n"
"border: 1px solid  black;")
        ...
        self.lineEdit.setStyleSheet("border-radius:6;\n"
"background-color: rgb(255, 255, 255);\n"
"border: 1px solid  black;")
        ...
        self.menu.setStyleSheet("background-color: rgb(157, 233, 255);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_3.setText(_translate("MainWindow", "Блок-схема"))
