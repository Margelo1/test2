...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Авиапассажиры"))
        self.radioButton.setText(_translate("MainWindow", "Наименования_авипредприятия"))
        self.radioButton_2.setText(_translate("MainWindow", "Фамилия"))
        self.radioButton_3.setText(_translate("MainWindow", "Дата вылета"))
