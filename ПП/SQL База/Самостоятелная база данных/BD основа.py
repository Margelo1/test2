...
class MyWin(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        conn = sqlite3.connect('Болотников.db')
        cursor = conn.cursor()
        cursor.execute('Select * from Aviapassajiri')
        data = []
        ...
        self.ui.tableWidget.setHorizontalHeaderLabels(['№','Авиапредприятия','Город назнчения','Страна','Рейса','Дата вылета','Фамилия','Класс_места']) 
    ...
    def on_selected_1(self):
        ...
        if self.ui.radioButton.isChecked() and len(text) !=0:
            try:
                ...
                conn = sqlite3.connect('Болотников.db')
                cursor2 = conn.cursor()
                ss = 'Наименование_авиапредприятия='+str('"'+text+'"')
                print(ss)
                cursor2.execute('Select * from Aviapassajiri WHERE '+str(ss))
                proba = []
            ...
            try:
                ...
                print(ss2)
                cursor2.execute('Select * from Aviapassajiri WHERE '+str(ss2))
                proba = []
                proba = cursor2.fetchall()
            ...
            try:
                ...
                conn = sqlite3.connect('Болотников.db')
                cursor2 = conn.cursor()
                ss3 = 'Дата_вылета ='+str('"'+text+'"')
                print(ss3)
                cursor2.execute('Select * from Aviapassajiri WHERE '+str(ss3))
                proba = []
                proba = cursor2.fetchall()
    ...
    def udalit(self):
        try:
            def delete_sqlite_record(dev_id):
                try:
                    sqlite_connection = sqlite3.connect('Болотников.db')
                    cursor = sqlite_connection.cursor()
                    print("Подключен к SQLite")

                    sql_update_query = """DELETE from Aviapassajiri where № = ?"""
            ...
            if int(col) == 0:
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set № = ? where Наименование_авиапредприятия = ?"""
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Наименование_авиапредприятия = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Город_назначения = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Страна = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Номер_рейса = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Дата_вылета = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Фамилия = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
                ...
                def update_multiple_records(record_list):
                    try:
                        ...
                        sqlite_update_query = """Update Aviapassajiri set Класс_места = ? where № = ?"""
                        cursor.executemany(sqlite_update_query, record_list)
                        sqlite_connection.commit()
                        print("Записей", cursor.rowcount, ". Успешно обновлены")
                        sqlite_connection.commit()
...
class Window1(QWidget):
    def __init__(self, parent = None):
        ...
        self.tableWidget_2.setHorizontalHeaderLabels(['№','Авиапредприятия','Город назнчения','Страна','Рейса','Дата вылета','Фамилия','Класс_места']) 
    ...
    def texty(self):
        ...
        def insert_multiple_records(records):
            try:
                ...
                sqlite_insert_query = """INSERT INTO Aviapassajiri VALUES (?, ?, ?, ?, ?, ?, ?, ?);"""
