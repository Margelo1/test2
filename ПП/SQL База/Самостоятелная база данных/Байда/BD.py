...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Переселенцы"))
        self.radioButton.setText(_translate("MainWindow", "Населенный пункт"))
        self.radioButton_2.setText(_translate("MainWindow", "Фамилия"))
        self.radioButton_3.setText(_translate("MainWindow", "Откуда прибыл"))
